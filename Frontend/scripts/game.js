...
const ICO_STYLE = 'display:inline-block;vertical-align:middle;flex-shrink:0;filter:invert(67%) sepia(89%) saturate(500%) hue-rotate(157deg) brightness(105%);';

const PILL_SVGS = {
  generic: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#00b8d9" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>`
};
